    ...
    public function checkdbAction()
    {
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-task-gallery',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-task-gallery/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-task-gallery/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-task-gallery/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key' => 'oneplace-task-gallery',
                'type' => 'plugin',
                'version' => \OnePlace\Task\Gallery\Module::VERSION,
                'label' => 'onePlace Task Gallery',
                'vendor' => 'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Task Gallery DB Update successful');
